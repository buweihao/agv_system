...
public static class DebugDashboardRegistration
{
    public static void RegisterDebugDashboard(IContainerRegistry containerRegistry)
    {
        ...
        containerRegistry.RegisterSingleton<IVehicleMotionScheduler, VehicleMotionScheduler>();
        containerRegistry.RegisterSingleton<IVehicleMotionSimulationService, VehicleMotionSimulationService>();
